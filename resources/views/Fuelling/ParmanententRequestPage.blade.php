                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('store_fuel_request') }}" method="post"
                                                    ...
                                                    <div class="row mb-3 entry">
                                                        <div class="col-md-3">
                                                            <div class="position-relative">
                                                                ...
                                                                <input id="Fuel_ammount" class="form-control"
                                                                    placeholder="In Litter" type="number">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="position-relative">
                                                                ...
                                                                <input id="fuel_price" class="form-control"
                                                                    placeholder="In Birr" type="number">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="position-relative">
                                                                ...
                                                                <input id="fill_date" class="form-control"
                                                                    placeholder="When" type="text">
                                                            </div>
                                                        </div>
                                                        <script>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="position-relative">
                                                                ...
                                                                <input id="attachment" name="Driving_license"
