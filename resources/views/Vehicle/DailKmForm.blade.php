                            ...
                            <div class="tab-content b-0 mb-0">
                                ...
                                <div class="tab-pane" id="account-2">
                                    <div class="row">
                                        ...
                                        <form action="{{route('daily_km.page.morning')}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="position-relative mb-3" id="morning" style="display:none">
                                                ...
                                                <ul class="list-inline wizard mb-0">
                                                    <li class="next list-inline-item float-end">
                                                        <button type="submit" class="btn btn-info">Submit Morning</button>
                                                    </li>
                                                </ul>
                                            </div>
                                        </form>
                                        <form action="{{route('daily_km.page.evening')}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="position-relative mb-3" id="evening" style="display:none">
                                                <div class="mb-6 position-relative" >
                                                    <label class="form-label">Evening KM</label>
                                                    <input type="text" name="afternoon_km" class="form-control" placeholder="Enter Evening KM">
                                                    <input type="hidden" id="vehicle_id_hidden_afternoon" name="vehicle">
                                                </div></br>
                                                <ul class="list-inline wizard mb-0">
                                                    <li class="next list-inline-item float-end">
                                                        <button type="submit" class="btn btn-info">Submit Evening</button>
                                                    </li>
                                                </ul>
                                            </div>
                                        </form>
                       ...
                       @foreach($TodaysDate as $data)
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info rounded-pill" data-bs-toggle="modal" data-bs-target="#standardmodal-{{ $loop->index }}" title="Show"><i class=" ri-eye-line"></i></button>
                                        <button type="button" class="btn btn-danger rounded-pill" data-bs-toggle="modal" data-bs-target="" title="Reject"><i class=" ri-close-circle-fill"></i></button>    
                                    </td>
                                </tr>
                            </tbody>
                           
                            <!-- edit the information of the request modal -->
                                <div id="standardmodal-{{ $loop->index }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="standard-modalLabel">Daily Km update</h4>
                                                ...
                                                <div class="tab-pane" id="account-2">
                                                    ...
                                                    <div class="position-relative mb-3">
                                                            <div class="mb-6 position-relative" id="datepicker1">
                                                                ...
                                                                <input type="text" name="afternoon_km" class="form-control" value="{{$data->vehicle->plate_number}}" readonly  tabindex="-1" style="user-select: none; pointer-events: none;">
                                                            </div>
                                                        </div>
                                                        <div class="position-relative mb-3">
                                                            <div class="mb-6 position-relative" id="datepicker1">
                                                                <label class="form-label">Morning km</label>
                                                                <input type="text" name="afternoon_km" class="form-control" value="{{$data->morning_km}}">
                                                            </div>
                                                        </div>
...
document.getElementById('department_id').addEventListener('change', function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (!response.message.includes('Morning km is filled') && !response.message.includes('Afternoon km is filled')) {
