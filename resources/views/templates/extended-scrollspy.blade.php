                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Scroll the area below the navbar and watch the active class change. The dropdown items will be highlighted as well.</p>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Scrollspy also works with nested <code>.nav</code>s.
...
<!-- Mirrored from techzaa.getappui.com/velonic/layouts/extended-scrollspy.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Oct 2023 02:30:09 GMT -->
</html>