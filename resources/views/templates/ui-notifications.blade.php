                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Push notifications to your visitors with a toast, a
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p class="text-muted mb-0">Toasts are as flexible as you need and
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="toast fade show" role="alert" aria-live="assertive"
                                                    ...
                                                    <div class="toast-header">
                                                        <img src="assets/images/logo-sm.png" alt="brand-logo"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p class="text-muted mb-0">Toasts are slightly translucent, too,
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-4">
                                            ...
                                            <p class="text-muted mb-0">Place toasts with custom CSS as you
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Alternatively, you can also add additional controls
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Place toasts with custom CSS as you need them. The top
                                    ...
                                    <div aria-live="polite" aria-atomic="true"
                                        ...
                                        <div class="toast-container position-absolute p-3" id="toastPlacement">
                                            <div class="toast show">
                                                <div class="toast-header">
                                                    <img src="assets/images/logo-sm.png" alt="brand-logo" height="16"
                                                        class="me-1" />
                                                    <strong class="me-auto">Velonic</strong>
                                                    <small>11 mins ago</small>
                                                </div>
...
<!-- Mirrored from techzaa.getappui.com/velonic/layouts/ui-notifications.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Oct 2023 02:30:06 GMT -->
</html>