                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Similar to the contextual text color classes, set the background of an element to any contextual class. Background
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="bg-pink text-dark p-2 mb-2">.bg-pink</div>
                                    <div class="bg-purple text-dark p-2 mb-2">.bg-purple</div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">By adding a <code>.bg-gradient</code> class, a linear gradient is added as background image to the backgrounds. This
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="p-2 mb-2 bg-pink bg-gradient text-dark">.bg-pink.bg-gradient</div>
                                    <div class="p-2 mb-2 bg-purple bg-gradient text-dark">.bg-purple.bg-gradient</div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Similar to the contextual text color classes, set the background of an element to any contextual class. Background utilities do not set <code>color</code>, so in some cases you’ll want to use <code>.text-*</code> <a href="https://getbootstrap.com/docs/5.3/utilities/colors/">color utilities</a>.</p>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="d-flex flex-column gap-2">
                                                ...
                                                <div class="bg-pink-subtle p-2"><code class="text-pink-emphasis">.bg-pink-subtle</code></div>
                                                <div class="bg-purple-subtle p-2"><code class="text-purple-emphasis">.bg-purple-subtle</code></div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Color and background helpers combine the power of our <code>.text-*</code> utilities and <code>.bg-*</code> utilities in one class. Using our Sass <code>color-contrast()</code> function, we automatically determine a contrasting <code>color</code> for a particular <code>background-color</code>.</p>
                                </div>
                                <div class="card-body">
                                    <div class="d-flex flex-column gap-2">
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0"><code>background-color</code> utilities are generated with Sass using CSS variables. This
                                        allows for real-time color changes without compilation and dynamic alpha transparency changes.</p>
                                </div>
                                <div class="card-body">
                                    <div class="text-bg-primary p-2">This is default primary background</div>
                                    <div class="text-bg-primary p-2 bg-opacity-75">This is 75% opacity primary background</div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Colorize text with color utilities. If you want to colorize links, you can use the <code>.link-*</code> helper classes which have <code>:hover</code>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p class="text-pink-emphasis">.text-pink-emphasis</p>
                                            <p class="text-purple">.text-purple</p>
                                            <p class="text-purple-emphasis">.text-purple-emphasis</p>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">text color utilities are generated with Sass using CSS variables. This allows for real-time color
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">The <code>opacity</code> property sets the opacity level for an element. The opacity level describes the transparency
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Use border utilities to <b>add</b> an element’s borders. Choose from all borders or one at a time.</p>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Use border utilities to <b>remove</b> an element’s borders. Choose from all borders or one at a time.</p>
                                    </div>
                                    <div class="card-body">
                                        <div class="d-flex align-items-start flex-wrap gap-4">
                                            <div class="text-center">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Change the border color using utilities built on our theme colors.</p>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="header-title mb-0">Border Width Size</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="d-flex align-items-start flex-wrap gap-2">
                                            <div class="text-center">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">choose from any of the <code>.border-opacity</code> utilities:</p>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Add classes to an element to easily round its corners.</p>
                                    </div>
                                    <div class="card-body">
                                        <div class="d-flex align-items-start flex-wrap gap-2">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Use the scaling classes for larger or smaller rounded corners. Sizes range from <code>0</code> to <code>5</code>.</p>
                                    </div>
                                    <div class="card-body">
                                        <div class="d-flex align-items-start flex-wrap gap-2">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Use <code>user-select-all</code>, <code>user-select-auto</code>, or
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Bootstrap provides <code>.pe-none</code> and <code>.pe-auto</code> classes to prevent or add element interactions.</p>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Adjust the <code>overflow</code> property on the fly with four default values and classes. These classes are not
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Arrange elements easily with the edge positioning utilities. The format is <code>{property}-{position}</code>.</p>
                                    </div>
                                    <div class="card-body">
                                        <!-- Arrange elements -->
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">In addition, you can also center the elements with the transform utility class <code>.translate-middle</code>.</p>
                                    </div>
                                    <div class="card-body">
                                        <!-- Center elements -->
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">By adding <code>.translate-middle-x</code> or <code>.translate-middle-y</code> classes, elements can be positioned only in horizontal or vertical direction.</p>
                                    </div>
                                    <div class="card-body">
                                        <!-- Center elements -->
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">While shadows on components are disabled by default in Bootstrap and can be enabled via
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Width utilities are generated from the utility API in <code>_utilities.scss</code>. Includes support for
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Height utilities are generated from the utility API in <code>_utilities.scss</code>. Includes support for
                                            <code>25%</code>, <code>50%</code>, <code>75%</code>, <code>100%</code>, and <code>auto</code> by default. Modify
                                            those values as you need to generate different utilities here.
                                        </p>
                                    </div>
...
<!-- Mirrored from techzaa.getappui.com/velonic/layouts/ui-utilities.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Oct 2023 02:30:08 GMT -->
</html>