                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" id="userName2" name="userName2" value="Velonic">
                                                                </div>
                                                            </div>
                                                            <div class="row mb-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="text" class="form-control" id="userName1" name="userName1" value="Velonic">
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-3">
...
<!-- Mirrored from techzaa.getappui.com/velonic/layouts/form-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Oct 2023 02:30:19 GMT -->
</html>
