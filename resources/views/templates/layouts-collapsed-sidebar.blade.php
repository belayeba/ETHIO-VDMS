                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Collapsed</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Collapsed</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
...
<!-- Mirrored from techzaa.getappui.com/velonic/layouts/layouts-collapsed-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Oct 2023 02:31:03 GMT -->
</html> 