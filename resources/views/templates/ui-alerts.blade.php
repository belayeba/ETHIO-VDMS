                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-pink text-bg-pink border-0" role="alert">
                                        <strong>Pink - </strong> A simple pink alert—check it out!
                                    </div>
                                    <div class="alert alert-purple text-bg-purple border-0" role="alert">
...
<!-- Mirrored from techzaa.getappui.com/velonic/layouts/ui-alerts.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Oct 2023 02:30:03 GMT -->
</html>