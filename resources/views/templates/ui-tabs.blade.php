                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Using class <code>.nav-justified</code>, you can force your <code>tab menu items</code> to use the full available width.</p>
                                    </div>
                                    <div class="card-body">
...
<!-- Mirrored from techzaa.getappui.com/velonic/layouts/ui-tabs.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Oct 2023 02:30:07 GMT -->
</html>
