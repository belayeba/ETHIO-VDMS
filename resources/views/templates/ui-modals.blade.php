                                                ...
                                                <div class="modal-body">
                                                    <div
                                                        ...
                                                        <a href="index.html" class="logo-dark">
                                                            <span><img src="assets/images/logo-dark.png"
                                                                    alt="dark logo" height="22"></span>
                                                        </a>
                                                        <a href="index.html" class="logo-light">
                                                            <span><img src="assets/images/logo.png" alt="logo"
                                                                    height="22"></span>
                                                        </a>
                                                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Show different contexual alert messages using modal
                                        component</p>
                                </div>
                                <div class="card-body">
                                    <!-- Success Alert Modal -->
                                    ...
                                    <!-- Pink Alert Modal -->
                                    <div id="pink-alert-modal" class="modal fade" tabindex="-1" role="dialog"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                    ...
                                    <!-- Purple Alert Modal -->
                                    <div id="purple-alert-modal" class="modal fade" tabindex="-1" role="dialog"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <button type="button" class="btn btn-pink" data-bs-toggle="modal"
                                            data-bs-target="#pink-alert-modal">Pink Alert</button>
                                        <!-- Purple Alert modal -->
                                        <button type="button" class="btn btn-purple" data-bs-toggle="modal"
                                            data-bs-target="#purple-alert-modal">Purple Alert</button>
                                    </div>
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Specify the position for the modal. You can display
                                        modal at top, bottom, center or right of page by specifying
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">A rendered modal with header having contexual background
                                        color.</p>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header modal-colored-header bg-primary">
                                                    <h4 class="modal-title" id="primary-header-modalLabel">Modal
                                                        Heading</h4>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header modal-colored-header bg-success">
                                                    <h4 class="modal-title" id="success-header-modalLabel">Modal
                                                        Heading</h4>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header modal-colored-header bg-info">
                                                    <h4 class="modal-title" id="info-header-modalLabel">Modal Heading
                                                    </h4>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header modal-colored-header bg-warning">
                                                    <h4 class="modal-title" id="warning-header-modalLabel">Modal
                                                        Heading</h4>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header modal-colored-header bg-danger">
                                                    <h4 class="modal-title" id="danger-header-modalLabel">Modal
                                                        Heading</h4>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                    ...
                                    <!-- Danger Header Modal -->
                                    <div id="pink-header-modal" class="modal fade" tabindex="-1" role="dialog"
                                        aria-labelledby="pink-header-modalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header modal-colored-header bg-pink">
                                                    <h4 class="modal-title" id="pink-header-modalLabel">Modal Heading
                                                    </h4>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                    ...
                                    <!-- Danger Header Modal -->
                                    <div id="purple-header-modal" class="modal fade" tabindex="-1" role="dialog"
                                        aria-labelledby="pink-header-modalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header modal-colored-header bg-purple">
                                                    <h4 class="modal-title" id="purple-header-modalLabel">Modal
                                                        Heading</h4>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-light"
                                                        data-bs-dismiss="modal">Close</button>
                                                    <button type="button" class="btn btn-purple">Save
                                                        changes</button>
                                                </div>
                                            </div><!-- /.modal-content -->
                                        </div><!-- /.modal-dialog -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">A rendered modal with header, body and footer having
                                        contexual background color.</p>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div id="fill-primary-modal" class="modal fade" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content modal-filled bg-primary">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="fill-primary-modalLabel">Primary
                                                        Filled Modal</h4>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                    ...
                                    <div id="fill-success-modal" class="modal fade" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content modal-filled bg-success">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="fill-success-modalLabel">Success
                                                        Filled Modal</h4>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                    ...
                                    <div id="fill-info-modal" class="modal fade" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content modal-filled bg-info">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="fill-info-modalLabel">Info Filled
                                                        Modal</h4>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                    ...
                                    <div id="fill-warning-modal" class="modal fade" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content modal-filled bg-warning">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="fill-warning-modalLabel">Warning
                                                        Filled Modal</h4>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                    ...
                                    <div id="fill-danger-modal" class="modal fade" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content modal-filled bg-danger">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="fill-danger-modalLabel">Danger Filled
                                                        Modal</h4>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                    ...
                                    <!-- Danger Filled Modal -->
                                    <div id="fill-pink-modal" class="modal fade" tabindex="-1" role="dialog"
                                        aria-labelledby="fill-pink-modalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content modal-filled bg-pink">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="fill-pink-modalLabel">Danger Filled
                                                        Modal</h4>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                    ...
                                    <div id="fill-purple-modal" class="modal fade" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content modal-filled bg-purple">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="fill-purple-modalLabel">Danger Filled
                                                        Modal</h4>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                    ...
                                    <div id="fill-dark-modal" class="modal fade" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content modal-filled bg-dark">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="fill-dark-modalLabel">Dark Filled
                                                        Modal</h4>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <!-- Pink header modal -->
                                        <button type="button" class="btn btn-pink" data-bs-toggle="modal"
                                            data-bs-target="#fill-pink-modal">Pink Filled</button>
                                        <!-- Purple header modal -->
                                        <button type="button" class="btn btn-purple" data-bs-toggle="modal"
                                            data-bs-target="#fill-purple-modal">Purple Filled</button>
                                        <!-- Dark header modal -->
                                        <button type="button" class="btn btn-dark" data-bs-toggle="modal"
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Display a series of modals one by one to guide your
                                        users on multiple aspects or take step wise input.</p>
                                </div>
                                <div class="card-body">
                                    <!-- Modal -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Toggle between multiple modals with some clever
                                        placement of the <code>data-bs-target</code> and <code>data-bs-toggle</code>
                                        attributes.</p>
                                </div>
                                <div class="card-body">
                                    <!-- Modal -->
                                    ...
                                    <div class="modal fade" id="exampleModalToggle2" aria-hidden="true"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalToggleLabel2">Modal 2
                                                    </h5>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Another override is the option to pop up a modal that
                                        covers the user viewport, available via modifier classes that are placed on a
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">When backdrop is set to static, the modal will not
                                        close when clicking outside it. Click the button below to try it.</p>
                                </div>
                                <div class="card-body">
                                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Have a bunch of buttons that all trigger the same modal
                                        ...
                                        <code>event.relatedTarget</code> and <a
                                            ...
                                            attributes</a> to vary the contents of the modal depending on which button
                                        was clicked.
                                    </p>
                                </div>
                                <div class="card-body">
                                    <div class="hstack gap-2 flex-wrap">
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal" data-bs-whatever="@mdo">Open modal for
                                            @mdo</button>
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal" data-bs-whatever="@fat">Open modal for
                                            @fat</button>
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
...
<!-- Mirrored from techzaa.getappui.com/velonic/layouts/ui-modals.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Oct 2023 02:30:05 GMT -->
