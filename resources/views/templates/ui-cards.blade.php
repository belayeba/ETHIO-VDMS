                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="row g-0 align-items-center">
                                    <div class="col-md-4">
                                        <img src="assets/images/small/small-4.jpg" class="img-fluid rounded-start"
                                            alt="...">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-group">
                                ...
                                <div class="card d-block">
                                    <img class="card-img-top" src="assets/images/small/small-3.jpg"
                                        alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title">Card title</h5>
                                        <p class="card-text">This is a wider card with supporting text below as a
...
<!-- Mirrored from techzaa.getappui.com/velonic/layouts/ui-cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Oct 2023 02:30:04 GMT -->
</html>