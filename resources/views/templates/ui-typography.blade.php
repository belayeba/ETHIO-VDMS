                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Available color variations.</p>
                                    </div>
                                    <div class="card-body">
                                        <p class="text-muted">
                            ...
                            <div class="col-xl-4">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">A list of items in which the order does not explicitly matter.</p>
                                    </div>
                                    <div class="card-body">
                                        <ul>
                                            <li>
                            ...
                            <div class="col-xl-4">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">A list of items in which the order does explicitly matter.</p>
                                    </div>
                                    <div class="card-body">
                                        <ol>
                                            <li>
...
<!-- Mirrored from techzaa.getappui.com/velonic/layouts/ui-typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Oct 2023 02:30:08 GMT -->
</html>
