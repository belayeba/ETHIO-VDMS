                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p><a href="#" class="link-pink">Pink link</a></p>
                                        <p><a href="#" class="link-purple">Purple link</a></p>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0"><a href="ui-utilities.html">Colored link helpers</a> have been updated to pair with our link utilities. Use the new utilities to modify the link opacity, underline opacity, and underline offset.</p>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Change the alpha opacity of the link <code>rgba()</code> color value with utilities. Please be aware that changes to a color’s opacity can lead to links with <em>insufficient</em> contrast.</p>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">You can even change the opacity level on hover.</p>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Change the underline’s color independent of the link text color.</p>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Change the underline’s opacity. Requires adding <code>.link-underline</code> to first set an <code>rgba()</code> color we use to then modify the alpha opacity.</p>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Just like the <code>.link-opacity-*-hover</code> utilities, <code>.link-offset</code> and <code>.link-underline-opacity</code> utilities include <code>:hover</code> variants by default. Mix and match to create unique link styles.</p>
                                    </div>
                                    <div class="card-body">
...
<!-- Mirrored from techzaa.getappui.com/velonic/layouts/ui-links.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Oct 2023 02:30:05 GMT -->
</html>
