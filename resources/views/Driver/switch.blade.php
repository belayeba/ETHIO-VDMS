                        ...
                        <div class="container-fluid p-0">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="mb-0">Driver Change</h3>
                                        </div>
                                        <div class="card-body">
                                            <form method="POST" action="" accept-charset="UTF-8" name="driver_change-form" id="driver_change-form" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row mb-3">
                                                    <label class="col-md-3 col-form-label" for="vehicle">Vehicle</label>
                                                    <div class="col-md-9">
                                                        <select id="vehicleCategory" name="vehicle" class="form-select" required>
                                                ...
                                                {{-- <div class="row mb-3">
                                                    <label class="col-md-3 col-form-label" for="driver_change">Inspection</label>
                                                    <div class="col-md-9">
                                                        <select id="vehicleCategory" name="driver_change" class="form-select" required>
                                                            <option value="">Select Inspection</option>
                                                        </select>
                                                    </div>
                                                </div> --}}
                                                <div class="row mb-3">
                                                    <label class="col-md-3 col-form-label" for="driver_change">New Driver</label>
                                                    <div class="col-md-9">
                                                        <select id="vehicleCategory" name="driver_change" class="form-select" required>
                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="mb-0">Driver change list</h3>
                                        </div>
                                        <div class="card-body">
