                                        ...
                                        <table class="table table-centered mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $item->name }}</td>
                                                    <td>
                                                        <form method="POST" action="{!! route('cluster.destroy',$item->cluster_id) !!}"accept-charset="UTF-8">
                                                            <input name="_method" value="DELETE" type="hidden">
                                                            {{ csrf_field() }}
                                                            <a href="{{ route('cluster.edit', $item->cluster_id) }}" class="btn btn-outline-warning btn-sm" title="Edit Cluster">Edit</a>
                                                            <button type="submit" class="btn btn-outline-danger btn-sm" title="Delete Cluster">Delete</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                            </tbody>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('cluster.store') }}" method="POST" class="ps-3 pe-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="name" id="name" required placeholder="Enter Cluster Name ....">
                            </div>
