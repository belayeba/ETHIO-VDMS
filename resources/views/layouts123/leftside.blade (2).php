<div class="left-sidenav">
            ...
            <div class="menu-content h-100" data-simplebar>
                <ul class="metismenu left-sidenav-menu">
                    <li class="menu-label mt-0"><h6>Main</h6></li>
                    <!-- <li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('voices.voice.index') }}"><i  class="align-self-center fas fa-file-audio"></i>ድምጽን ወደ ጽሁፍ መቀየሪያ </a></li>
                    </li>
                    @endcan
                    ...
                    @can('role-list')
                    <li class="nav-item"><a class="nav-link" href="{{ route('settings.setting.index') }}"><i  class="align-self-center fas fa-calendar-alt"></i>ቀኖች ያስተካክሉ</a></li>
                    </li>
                    @endcan
