                                ...
                                <div class="card-body">
                                    <div class="table-responsive"  id="table1">
                                        ...
                                        <table class="table table-centered mb-0 table-nowrap" id="inline-editable">
                                            ...
                                            @foreach($vehicleRequests->where('div_approved_by', '===', NULL) as $request)
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if($request->div_approved_by === Null && $request->cluster_director_reject_reason === Null)
                                                    ...
                                                    <form id="approvalForm-{{ $loop->index }}" method="POST" action="{{ route('ClusterDirector_approve_request') }}" style="display: none;">
                                                        @csrf
                                    ...
                                    <div class="table-responsive"  id="table2" style="display:none">
                                        ...
                                        <table class="table table-centered mb-0 table-nowrap" id="inline-editable">
                                            ...
                                            @foreach($vehicleRequests->where('div_approved_by', '!==', null)->where('hr_div_approved_by', null) as $request)
                                                <tbody>
                                                    <tr>
                                                        <td>{{$loop->iteration}}</td>
                                                        <td>{{$request->requestedBy->first_name}}</td>
                                                        ...
                                                        <td>{{$request->end_locations}}</td>
                                                        <td>{{$request->created_at}}</td>
                                                        <td> @if($request->div_approved_by !== null && $request->cluster_director_reject_reason === null)
                                                                <p class="btn btn-primary ">ACCEPTED</p>
                                                             @elseif($request->div_approved_by !== null && $request->cluster_director_reject_reason !== null)
