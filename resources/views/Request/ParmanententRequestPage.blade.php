                    ...
                    <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                        ...
                        @foreach($Requested as $request)
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="standard-modalLabel">Request Update</h4>
                                                ...
                                                @csrf
                                                        ...
                                                        <div class="tab-pane" id="account-2">
                                                            <div class="row">
                                                                ...
                                                                <div class="position-relative mb-3">
                                                                    <label class="form-label">Upload Driving License</label>
                                                                    <input name="Driving_license" class="form-control" type="file" required>
                                                                </div>
                                                            </div>
                                                        </div> 
                                                </div>
                            ...
                            <!-- end show modal -->
                              ...
                              <div id="showinspection-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="standard-modalLabel">Inspection Details</h4>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body"> 
