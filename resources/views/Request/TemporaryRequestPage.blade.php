                                    ...
                                    <div class="row">
                                        ...
                                        <div class="position-relative mb-3">
                                            <div class="mb-6 position-relative" id="datepicker1">
                                                ...
                                                <input type="number" class="form-control" name="how_many_days" placeholder="Enter the Duration"
                                                    data-provide="datepicker" data-date-today-highlight="true"
                                                    data-date-container="#datepicker1">
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane" id="finish-3">
                                    <div class="row">
                                        ...
                                        <div class="mt-2">
                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" class="form-check-input"  name="with_driver" value="1">
                                                <label class="form-check-label" >Yes</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" class="form-check-input" name="with_driver" value="0">
                                        ...
                                        <div class="mt-2">
                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" class="form-check-input"  name="in_out_town" value="1">
                                                <label class="form-check-label">In town</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" class="form-check-input" name="in_out_town" value="0">
                                        ...
                                        <div class="mt-2">
                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" class="form-check-input"  name="package" value="1">
                                                <label class="form-check-label">Yes</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" class="form-check-input" name="package" value="0">
                                                <label class="form-check-label" >No</label>
                                            </div>
                                        </div></br>
                                    ...
                                    <ul class="pager wizard mb-0 list-inline mt-1">
                                        ...
                                        <script>
                                            ...
                                            //         location.reload();
                                            //     };
                                            const checkboxes = document.querySelectorAll('input[name="with_driver"], input[name="in_out_town"], input[name="package"]');
