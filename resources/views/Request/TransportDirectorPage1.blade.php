                                        ...
                                        <table class="table table-centered mb-0 table-nowrap" id="inline-editable">
                                            ...
                                            @foreach($vehicleRequests->where('transport_director_id', '===', null) as $request)
                                                <tbody>
                                                    ...
                                                    <form id="approvalForm-{{ $loop->index }}" method="POST" action="{{ route('TransportDirector_approve_request') }}" style="display: none;">
                                                        @csrf
                                            ...
                                            @foreach($vehicleRequests->where('transport_director_id', '!==', null) as $request)
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>{{$request->end_locations}}</td>
                                                        <td>{{$request->created_at}}</td>
                                                        <td> @if($request->transport_director_id !== null && $request->vec_director_reject_reason === null)
