...
class FeulController extends Controller
{
    ...
    public function DirectorApprovalPage()
        {
                ...
                // Retrieve fuel requests made by other users in the same department, excluding the current user's requests
                $Fuel_Requests = FuelsModel::whereHas('requestedBy', function ($query) use ($dept_id, $id) {
    ...
    public function VehicleDirector_page() 
        {    
                $Fuel_Request = FuelsModel::latest()->limit(100)->get();
